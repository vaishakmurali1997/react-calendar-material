...
var Calendar = function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays(copy) {
      ...
      console.log("KKAA KKA :: ", copy);

      // if(this.props.selectedDays.length === 0) return null
      var days = [];
      var selectedDay = [];
      console.log("selected DAYAYA :: ", this.props.selectedDays);
      if (this.props.selectedDays != undefined || this.props.selectedDays != []) {
        for (var _i = 2; _i < this.props.selectedDays.length; _i++) {
          ...
          if (dates.split("-")[2].length < 2) {
            console.log("passed :: ", dates.split("-")[2]);
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps != undefined) {
        if (nextProps.selectedDays[0] != undefined) {
          console.log("BBA BBA :: ", nextProps.selectedDays);
          if (nextProps.selectedDays[0].date.split("-")[1].length < 2) {
            if (nextProps.selectedDays[0].date.split("-")[2].length < 2) {

              console.log("shit 1 : ", nextProps.selectedDays[0].date.split("-")[0] + '-0' + nextProps.selectedDays[0].date.split("-")[1] + '-0' + nextProps.selectedDays[0].date.split("-")[2]);
              ...
              console.log("shit 2 : ", nextProps.selectedDays[0].date.split("-")[0] + '-0' + nextProps.selectedDays[0].date.split("-")[1] + '-' + nextProps.selectedDays[0].date.split("-")[2]);
    ...
    value: function render() {
      ...
      console.log("PICE :: ", this.state.current.getTime());
